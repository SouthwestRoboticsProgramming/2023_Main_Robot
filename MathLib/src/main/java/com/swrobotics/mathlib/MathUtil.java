...
public final class MathUtil {
  ...
  /**
   * Clamps a value within a specified range. If the value is below the minimum, it will be clamped
   * up to the minimum, and if it is above the maximum, it will be clamped down to the maximum.
   *
  ...
  /**
   * Gets the percentage of the way from the minimum to the maximum the value is from 0 to 1. If the
   * input value is outside of the specified range, the percentage can be lower than 0 or higher
   * than 1.
   *
   * @param val input value
  ...
  /**
   * Wraps a value within specified bounds. If the value exceeds the bounds in either direction, it
