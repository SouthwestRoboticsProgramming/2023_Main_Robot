...
public final class Vec2d {
  ...
  /**
   * Subtracts a vector with the given components from this vector, and stores the result in another
   * vector.
   *
   * @param x x component to subtract
   * @param y y component to subtract
  ...
  /**
   * Multiplies this vector by a vector with the given components, and stores the result in another
   * vector.
   *
   * @param x x component to multiply by
   * @param y y component to multiply by
  ...
  /**
   * Computes the distance from this vector to a vector with the specified components, squared. See
   * the note in {@link #magnitudeSq()} about efficiency.
   *
  ...
  /**
   * Normalizes this vector by scaling it to be along the unit square. This guarantees that at least
   * one of the components will be 1, unless this vector is (0, 0).
   *
