...
// #[macroquad::main("Collisions test")]
// async fn main() {
//     let rects = [
//         Rectangle {
//             position: Vec2f { x: 400.0, y: 300.0 },
//             size: Vec2f { x: 200.0, y: 100.0 },
//             rotation: 1.0,
//             inverted: false,
//         },
//         Rectangle {
//             position: Vec2f { x: 100.0, y: 300.0 },
//             size: Vec2f { x: 50.0, y: 300.0 },
//             rotation: 3.0,
//             inverted: false,
//         },
//         Rectangle {
//             position: Vec2f { x: 400.0, y: 300.0 },
//             size: Vec2f { x: 750.0, y: 550.0 },
//             rotation: 0.0,
//             inverted: true,
//         },
//     ];
...
//         for rect in &rects {
//             let center = rect.position;
//             let corner_rel = rect.size / 2.0;
...
//         circle.position = Vec2f {
//             x: mouse_x as f64,
//             y: mouse_y as f64,
//         };
//         for rect in &rects {
//             let collide = collision::circle_rect_collides(&circle, &rect);
//             if collide {
//                 color = RED;
//             }
//         }
//         draw_circle_lines(mouse_x, mouse_y, circle.radius as f32, 3.0, color);
