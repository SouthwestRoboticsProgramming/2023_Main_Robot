...
public final class CanCoder {
  ...
  /**
   * Gets the relative encoder output from this CANCoder. This can be used as a feedback sensor for
   * Talon FX and Talon SRX motors.
   *
  ...
  /**
   * Gets the absolute encoder output from thie CANCoder. This cannot be used as a feedback sensor.
   *
