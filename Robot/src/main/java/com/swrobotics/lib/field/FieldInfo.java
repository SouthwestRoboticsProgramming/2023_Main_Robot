...
/**
 * Represents the information related to the layout of the
 * game field.
 */
public final class FieldInfo {
    /** Information for the 2023 Charged Up field */
    public static final FieldInfo CHARGED_UP_2023 = new FieldInfo(16.4846, 8.02, FieldSymmetry.LATERAL);
    ...
    /**
     * Gets the width of the field in meters. This is the horizontal distance
     * relative to the scoring table.
     *
    ...
    /**
     * Gets the height of the field in meters. This is the vertical distance
     * relative to the scoring table.
     *
    ...
    /**
     * Gets the angle pointing forward relative to the current alliance driver
     * station.
     *
    ...
    /**
     * Gets the angle pointing reverse relative to the current alliance driver
     * station.
     *
