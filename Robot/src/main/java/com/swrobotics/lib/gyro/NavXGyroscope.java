...
public final class NavXGyroscope extends Gyroscope {
  ...
  /**
   * Creates a new instance of the NavX gyroscope on a specified SPI port. It is not recommended to
   * have multiple instances of this class for the same NavX device.
   *
