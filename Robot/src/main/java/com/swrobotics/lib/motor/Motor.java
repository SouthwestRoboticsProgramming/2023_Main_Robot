...
public interface Motor {
    ...
    /**
     * Sets whether the motor's output should be inverted. If following another
     * motor, this determines whether to match or oppose the leader's output.
     *
    ...
    /**
     * Sets this motor to follow the output of another motor. If this motor is
     * not able to follow the given motor, it will throw an
     * UnsupportedOperationException. The following can be inverted using
     * {@link #setInverted(boolean)}.
     *
