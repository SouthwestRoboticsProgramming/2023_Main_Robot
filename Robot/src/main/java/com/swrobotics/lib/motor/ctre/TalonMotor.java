...
public abstract class TalonMotor implements FeedbackMotor {
  ...
  public static final class IntegratedEncoder implements Encoder {
    ...
    public Angle getAngle() {
      return CWAngle.rot(motor.talon.getSelectedSensorPosition() / motor.encoderTicksPerRotation);
    }
    ...
    public void setAngle(Angle angle) {
      motor.talon.setSelectedSensorPosition(angle.cw().rot() * motor.encoderTicksPerRotation);
    }
