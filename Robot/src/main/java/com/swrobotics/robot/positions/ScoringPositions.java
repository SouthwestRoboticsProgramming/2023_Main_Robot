...
public final class ScoringPositions {
    ...
    private static final Translation2d CONE_PICKUP = new Translation2d(0.723479, 0.779810);
    private static final Translation2d CUBE_PICKUP = new Translation2d(0.856392, 0.709345);
