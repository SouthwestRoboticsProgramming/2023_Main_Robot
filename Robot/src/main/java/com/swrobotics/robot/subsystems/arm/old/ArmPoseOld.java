...
import static com.swrobotics.robot.subsystems.arm.ArmConstants.BOTTOM_LENGTH;
import static com.swrobotics.robot.subsystems.arm.ArmConstants.TOP_LENGTH;

public final class ArmPoseOld {
...
//    }
    ...
    public static ArmPoseOld fromEndPosition(Translation2d position, double wristAngle) {
...
//        }
        ...
        return new ArmPoseOld(angle1, angle2, wristAngle);
    }
    ...
    public ArmPoseOld(double bottomAngle, double topAngle, double wristAngle) {
