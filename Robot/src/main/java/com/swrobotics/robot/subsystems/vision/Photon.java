    ...
    public Photon(RobotContainer robot) {
        ...
        frontPoseEstimator =
                new PhotonPoseEstimator(
                        layout, PhotonPoseEstimator.PoseStrategy.AVERAGE_BEST_TARGETS, frontCam, frontCamTransform);
        backPoseEstimator =
                new PhotonPoseEstimator(
                        layout, PhotonPoseEstimator.PoseStrategy.AVERAGE_BEST_TARGETS, backCam, backCamTransform);
