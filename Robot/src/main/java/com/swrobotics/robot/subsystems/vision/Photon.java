...
public class Photon extends SubsystemBase {
  ...
  private final Transform3d frontCamTransform =
      new Transform3d(
          ...
          new Rotation3d(0, 0, Math.toRadians(-17.78208933))); // Camera is facing perfectly forward
  ...
  private final Transform3d backCamTransform =
      new Transform3d(
          new Translation3d(
              ...
              Units.inchesToMeters(POWER_TOWER_X - 0.8715), // Left
              Units.inchesToMeters(POWER_TOWER_HEIGHT)), // Up
          new Rotation3d(0, 0, Math.toRadians(17.78208933))); // Camera is facing perfectly backward
  ...
  public Photon(RobotContainer robot) {
    ...
    if (RobotBase.isSimulation()) {
      frontSim =
          new SimVisionSystem("Front", 70, frontCamTransform, 9000, 320, 240, 0); // FIXME: FOV
