...
import com.swrobotics.robot.Settings;
import com.swrobotics.robot.Settings.Mode;
import com.swrobotics.robot.Settings.RobotType;

public class BatteryTracker {
  private static final List<RobotType> supportedRobots = List.of(RobotType.COMPETITION);
  ...
  public static String scanBattery(double timeout) {
    if (Settings.getMode() == Mode.REAL) {
      if (supportedRobots.contains(Settings.robot)) {
