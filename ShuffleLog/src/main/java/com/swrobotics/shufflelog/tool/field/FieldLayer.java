...
public interface FieldLayer {
  ...
  /**
   * Gets whether this layer should be sequentially offset to prevent z-fighting of 2D objects. This
   * should typically be disabled for 3D objects, so they render in the correct spot.
   *
