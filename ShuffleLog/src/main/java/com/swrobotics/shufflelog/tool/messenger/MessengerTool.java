...
public final class MessengerTool implements Tool {
  ...
  private static final QuickConnect[] QUICK_CONNECTS = {
    new QuickConnect("Robot", "10.21.29.3", 5805), new QuickConnect("Simulation", "localhost", 5805)
  };
  ...
  private void showClients() {
    if (!ImGui.treeNodeEx(
        "Connected clients (" + clientNames.size() + "):##clients", ImGuiTreeNodeFlags.DefaultOpen))
      return;
